...
const Dropdown = () => {
  ...
  return html`
    <div>
      ...
      />
      <input name="json" value=${JSON.stringify(data)} type="hidden" />
      <div id="results" class=${`absolute w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg ${showResults ? '' : 'hidden'}`}>
